...
% The fancyhdr package allows you to set your the page headers    jskd  
...
\usepackage{tikz}
% the following 2 lines are added by Rui Xue on 20150130 because of the reposition of tables:
% ref: http://stackoverflow.com/questions/1673942/latex-table-positioning  
\usepackage{float}
\restylefloat{table}
% Added by Rui Xue on 20150204
% ref: http://en.wikibooks.org/wiki/LaTeX/Special_Characters
\usepackage{pifont} %for inserting \ding{special char number}
...
\usepackage{appendix}
%\usepackage{ftnxtra} %footnote in caption
...
% ------------------------------------------------------------------
\newcommand{\TITLE}{Stream Processing Systems Benchmark:}
\newcommand{\SUBTITLE}{StreamBench}
\newcommand{\DATE}{May 15, 2016}
...
\newcommand{\SUPERVISOR}{Assoc. Prof.\ Aristides Gionis}

% If you have only one instructor, just write one name here
\newcommand{\INSTRUCTOR}{D.Sc.\ Gianmarco De Francisci Morales}

% If you have two supervisors, it is common to write the schools
% of the supervisors in the cover page. If the following command is defined,
% then the supervisor names shown here are printed in the cover page. Otherwise,
% the supervisor names defined above are used.
% \newcommand{\COVERSUPERVISOR}{Assoc. Prof. Keijo Heljanko}
...
\newcommand{\PROFCODE}{T-119}
\newcommand{\KEYWORDS}{Big Data, Stream, Benchmark, Storm, Flink, Spark}
...
\newcommand{\AUTHOR}{Yangjun Wang}
%ADDED BY RUI XUE 20151108
...
\startcoverpage\pagenumbering{roman}
...
Besides my advisors, I would like to thank all my friends in data mining group of Aalto university. Thanks for your advises and helps during my master study. I was a happy time to work with you and I have learnt a lot for you.

Last but not least, I want thank my parents for trying to support me with the best they can do all these years and all friends for their support and patience.
...
% This command is defined in aalto-thesis.sty. It controls the page 
% numbering based on whether the doublenumbering option is specified
\startfirstchapter\pagenumbering{arabic}\setcounter{page}{1}
...
\input{3platforms.tex}

\input{4benchmark.tex}

\input{5experiment.tex}
